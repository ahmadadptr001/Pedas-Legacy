    ...
    return (
        <div className="w-full">
            ...
            <section className="py-12 px-6 bg-base-100">
                ...
                <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 sm:grid-cols-1">
                    {[
                        ...
                        <div key={i} className="card bg-base-200 shadow-lg hover:shadow-xl transition-shadow duration-300">
                            <figure>
                                <img src={item.img} alt={item.title} className="h-48 w-full object-cover rounded-t-lg" />
                            </figure>
                            <div className="card-body">
                                <h3 className="card-title">{item.title}</h3>
                                <p>Rasakan pedasnya yang pas di lidah dan bikin ketagihan.</p>
                                <div className="card-actions justify-end">
                                    <button className="btn btn-sm btn-secondary hover:scale-105 transition-transform duration-300">Pesan Sekarang</button>
                                </div>
                            </div>
                        </div>
                    ))}
            ...
            {/* Call to Action */}
            <section className="py-12 bg-primary text-primary-content text-center px-4">
                <h2 className="text-3xl font-bold mb-4">Siap Tantang Pedas?</h2>
                <p className="mb-6 max-w-xl mx-auto">Ayo pesan sekarang dan nikmati promo spesial bulan ini!</p>
                <button className="btn btn-secondary btn-lg hover:scale-105 transition-transform duration-300">Pesan Sekarang</button>
            </section>
